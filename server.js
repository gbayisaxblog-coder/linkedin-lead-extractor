// server.js - FIXED VERSION (REMOVE DUPLICATES)
...
// Initialize queues and start workers - SINGLE INSTANCE ONLY
async function startServer() {
  try {
    ...
    try {
      ...
      console.log('🔍 DEBUG: Domain queue available after init:', !!queueModule.domainQueue);
      console.log('🔍 DEBUG: Queue initialized flag:', queueModule.initialized);
    ...
    app.listen(PORT, () => {
      ...
      setTimeout(() => {
        try {
          const queueModule = require('./utils/queue');
          console.log('🔍 DEBUG: Final domain queue check after server start:', !!queueModule.domainQueue);
          console.log('🔍 DEBUG: Final initialized flag:', queueModule.initialized);
          
          if (queueModule.getDomainQueue) {
            const domainQueue = queueModule.getDomainQueue();
            console.log('🔍 DEBUG: Domain queue via getter:', !!domainQueue);
          }
